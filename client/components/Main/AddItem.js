  ...
  return (
    <View style={{backgroundColor: "#FFFFFF",borderRadius:10,width:"100%",flexDirection:"row"}}>
        <View style={[{backgroundColor: "#FFFFFF",borderRadius:10},styles.inputWrappers]}>
            ...
            <TouchableOpacity disabled={uploadingImage === true|| imageURL} onPress={() => {setShowCamera(true)}} style={{fontWeight:'bold',marginTop:10}}><Text style={{color:"grey",fontWeight:"bold"}}>{uploadingImage ? "Uploading image..." : (imageURL ? "Image Uploaded" : "Add Image")}</Text></TouchableOpacity>
        </View>
