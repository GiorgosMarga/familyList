...
const AddItem = ({itemName,itemPrice,itemQuantity,itemStore,setItemName,setItemPrice,setItemQuantity,setItemStore,createItemHandler,showAddItemHandler,setShowCamera}) => {
  return (
    <View style={{backgroundColor: "#FFFFFF",borderRadius:10,width:"100%",flexDirection:"row"}}>
        <View style={[{backgroundColor: "#FFFFFF",borderRadius:10},styles.inputWrappers]}>
            ...
            <TouchableOpacity onPress={() => {setShowCamera(true)}} style={{fontWeight:'bold',marginTop:10}}><Text style={{color:"grey",fontWeight:"bold"}}>Add Image</Text></TouchableOpacity>
        </View>
