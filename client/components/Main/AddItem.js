...
const AddItem = ({itemName,itemPrice,itemQuantity,itemStore,setItemName,setItemPrice,setItemQuantity,setItemStore,createItemHandler,showAddItemHandler}) => {
  return (
    <View style={{backgroundColor: "#FFFFFF",borderRadius:10,width:"100%",flexDirection:"row"}}>
        <View style={[{backgroundColor: "#FFFFFF",borderRadius:10},styles.inputWrappers]}>
            ...
            <TextInput value={itemStore} onChangeText={(text) => setItemStore(text)} placeholder="Store (opt)" placeholderTextColor="grey" style={{fontWeight:'bold',marginTop:10}} keyboardType="numeric" />
        </View>
